...
*/
describe('efface un utilisateur', () => {

    it('devrait recuperer un utilisateur', async () => {
        let user = await new User({
            'name': 'user 1',
            'firstname': 'name user 1',
            'mail': 'mail user 1',
        ...
        expect(await User.findOne({_id: user._id})).toBe(null)
    })
})
 ...
 */
        describe('ajouter un utilisateur', () => {
            ...
            it('devrait ajouter un utilisateur', async () => {
                ...
                let userFinded = await User.findOne({_id: user._id})
                expect(userFinded._id).toEqual(user._id)
                expect(userFinded.name).toEqual(user.name)
                expect(userFinded.firstname).toEqual(user.firstname)
                expect(userFinded.mail).toEqual(user.mail)
            })
